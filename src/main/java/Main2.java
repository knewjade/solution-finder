...
//        Operations operations = createOperations("J,0,5,0", "T,2,5,1", "I,0,5,0");
        ...
        int height = 4;
        List<IOperationWithKey> objs = BuildUp.createOperationWithKeys(fieldOrigin, operations, minoFactory, height);

        System.out.println("---");
        for (IOperationWithKey obj : objs) {
        ...
        PermutationIterable<IOperationWithKey> iterable = new PermutationIterable<>(objs, objs.size());
        for (List<IOperationWithKey> list : iterable) {
