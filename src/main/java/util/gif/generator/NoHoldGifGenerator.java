...
public class NoHoldGifGenerator implements GifGenerator {
    ...
    public NoHoldGifGenerator(GifSetting setting, MinoFactory minoFactory, ColorConverter colorConverter) {
