...
public class MinoFieldMemento4 implements MinoFieldMemento {
    ...
    private MinoFieldMemento4() {
        this(null, null, null, null, 0);
    }

    private MinoFieldMemento4(MinoField minoField1) {
        this(minoField1, null, null, null, 1);
    }

    private MinoFieldMemento4(MinoField minoField1, MinoField minoField2) {
        this(minoField1, minoField2, null, null, 2);
    }

    private MinoFieldMemento4(MinoField minoField1, MinoField minoField2, MinoField minoField3) {
        this(minoField1, minoField2, minoField3, null, 3);
    }

    private MinoFieldMemento4(MinoField minoField1, MinoField minoField2, MinoField minoField3, MinoField minoField4) {
        this(minoField1, minoField2, minoField3, minoField4, 4);
    }

    private MinoFieldMemento4(MinoField minoField1, MinoField minoField2, MinoField minoField3, MinoField minoField4, int index) {
    ...
    public MinoFieldMemento4 concat(MinoField minoField) {
        switch (index) {
            case 0:
                return new MinoFieldMemento4(minoField);
            case 1:
                return new MinoFieldMemento4(minoField1, minoField);
            case 2:
                return new MinoFieldMemento4(minoField1, minoField2, minoField);
            case 3:
                return new MinoFieldMemento4(minoField1, minoField2, minoField3, minoField);
        }
        throw new IllegalStateException("No reachable");
    }

    public MinoFieldMemento4 skip() {
        return concat(null);
    }
    ...
    public Stream<OperationWithKey> getOperationsStream(int width) {
        ...
        switch (index) {
            case 4:
                if (minoField4 != null)
                    operations = Stream.concat(operations, addSlideX(minoField4.getOperationsStream(), width * 3));
            case 3:
                if (minoField3 != null)
                    operations = Stream.concat(operations, addSlideX(minoField3.getOperationsStream(), width * 2));
            case 2:
                if (minoField2 != null)
                    operations = Stream.concat(operations, addSlideX(minoField2.getOperationsStream(), width));
            case 1:
                if (minoField1 != null)
