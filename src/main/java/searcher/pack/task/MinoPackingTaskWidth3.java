...
class MinoPackingTaskWidth3 implements PackingTask {
    ...
    MinoPackingTaskWidth3(PackSearcher searcher, ColumnField innerField, MinoFieldMemento memento, int index) {
    ...
    private PackingTask createTask(PackSearcher searcher, ColumnField innerField, MinoFieldMemento memento, int index) {
        return new MinoPackingTaskWidth3(searcher, innerField, memento, index);
    }
