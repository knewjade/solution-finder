...
public class BasicSolutionsCalculator {
    ...
    private HashMap<ColumnField, RecursiveMinoFields> resultsMap = new HashMap<>();
    ...
    private static class CalculatorCoreThreadLocal extends ThreadLocal<CalculatorCore> {
        ...
        private final HashMap<ColumnField, RecursiveMinoFields> resultsMap;

        public CalculatorCoreThreadLocal(SizedBit sizedBit, BasicReference reference, SeparableMinos separableMinos, HashMap<ColumnField, RecursiveMinoFields> resultsMap) {
            this.sizedBit = sizedBit;
    ...
    private static class CalculatorCore {
        ...
        public CalculatorCore(SizedBit sizedBit, BasicReference reference, SeparableMinos separableMinos, HashMap<ColumnField, RecursiveMinoFields> resultsMap) {
            this.sizedBit = sizedBit;
            this.reference = reference;
            this.separableMinos = separableMinos;
            this.resultsMap = resultsMap;
        ...
        private Stream<RecursiveMinoField> calculate(ColumnField columnField, ColumnField outerColumnField, Field wallField, SeparableMino currentMino) {
            ...
            RecursiveMinoFields minoFields = resultsMap.getOrDefault(columnField, null);
            if (minoFields != null) {
