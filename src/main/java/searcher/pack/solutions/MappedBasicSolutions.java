...
public class MappedBasicSolutions implements BasicSolutions {
    ...
    public MappedBasicSolutions(Map<ColumnField, ? extends MinoFields> solutions) {
        assert solutions != null;
        this.solutions = solutions;
    }

    public MappedBasicSolutions(Map<ColumnField, ? extends MinoFields> solutions, SolutionFilter filter) {
