...
class LockedReachableTest {
    @Nested
    class Only90 {
        private final ILockedReachable reachable = createLockedReachable();

        private ILockedReachable createLockedReachable() {
            MinoFactory minoFactory = new MinoFactory();
            MinoShifter minoShifter = new PassedMinoShifter();
            MinoRotation minoRotation = SRSMinoRotationFactory.createDefault();
            return ReachableFacade.create90Locked(minoFactory, minoShifter, minoRotation, 8);
        }
